...
envarg.add_argument("--model_id", default=13452, type=int, help="Model id name to be loaded.")
...
LOG_FOLDER = './tboard_logs'
TEST_DATASET_DIR="./dataset/RGB_512_tfrecords"
TEST_FILE = 'validation.tfrecords'
